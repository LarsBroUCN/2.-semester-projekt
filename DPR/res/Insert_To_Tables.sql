...
--insert into batches (arrivaldate, expirationdate, warningperiod, barcode_fk ) values ('2021/05/14','2021/07/01',  12, 11111) --burde ikke lave en notifikation                            -- virker korrekt
--insert into batches (arrivaldate, expirationdate, warningperiod, barcode_fk ) values ('2021/05/14','2021/06/15',  12, 22222)  --burde lave en notifikation og sætte status til pending    -- virker korrekt
...
--insert into batches (arrivaldate, expirationdate, warningperiod, barcode_fk ) values ('2021/05/13','2021/06/01',  12, 66666)	--sættes til discount 
--insert into batches (arrivaldate, expirationdate, warningperiod, barcode_fk ) values ('2021/05/13','2021/05/26',  12, 77777)	--sættes til complete 
--insert into batches (arrivaldate, expirationdate, warningperiod, barcode_fk ) values ('2021/05/13','2021/05/26',  12, 33333)	--sættes til discard 


--insert into notifications (discount, note, status, batchID_fk) values (5, '', 'DISCOUNT', 4)
--insert into notifications (discount, note, status, batchID_fk) values (5, '', 'COMPLETE', 5)
--insert into notifications (discount, note, status, batchID_fk) values (5, '', 'DISCARD', 3)
